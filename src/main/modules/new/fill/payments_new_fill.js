angular.module('raiffeisen-payments')
    ...
    .controller('NewPaymentFillController', function ($scope, customerService, exchangeRates, rbDateUtils, translate, $filter, paymentRules, transferService, rbDatepickerOptions, bdFillStepInitializer, bdStepStateEvents, lodash, formService, validationRegexp) {
