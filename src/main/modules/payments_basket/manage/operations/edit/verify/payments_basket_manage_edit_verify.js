angular.module('raiffeisen-payments')
    .controller('PaymentBasketManageEditVerifyController', function ($scope, initialState, bdVerifyStepInitializer, transferService, RB_TOKEN_AUTHORIZATION_CONSTANTS, bdStepStateEvents,  $stateParams, authorizationService, formService, paymentsBasketService) {
        ...
        $scope.payment.token.params.rbOperationType = "MODIFY_PAYMENT_BASKET";
        ...
        function authorize(doneFn, actions) {
            paymentsBasketService.modifyPayment($scope.payment.transferId, $scope.payment.token.model.input.model).then(function (resultCode) {
