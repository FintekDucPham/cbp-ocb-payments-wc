...
}).service('accountSettingsService', function(customerService) {
    this.defaultAccount = function(productType) {
        customerService.getCustomerDefaultSettings().then(function(response) {
