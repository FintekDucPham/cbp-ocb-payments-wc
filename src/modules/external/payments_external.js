angular.module('ocb-payments')
    .config(function (pathServiceProvider, stateServiceProvider) {
        stateServiceProvider
                    ...
                    loadPayment: ['payment', 'paymentsService', '$stateParams', 'loadCurrentDate', '$state', '$timeout', function (payment, paymentsService, $stateParams, loadCurrentDate, $state, $timeout) {
                        ...
                        payment.promises.loadPayment = paymentsService.get($stateParams.referenceId + '@basket_edit_transaction').then(function (data) {
                            angular.extend(payment.formData, {
                                ...
                                province: data.paymentDetails.province,
                                bankCode: data.paymentDetails.bankCode,
                                branchCode: data.paymentDetails.branchCode,
            ...
            .state('payments.external.basket.delete', {
                url: '/delete',
                abstract: true,
                data: {
                    operation: 'delete'
            ...
            .state('payments.external.future', {
                url: '/future/manage',
                abstract: true,
                params: {
                    referenceId: null
                    ...
                    loadPayment: ['payment', 'paymentsService', '$stateParams', 'loadCurrentDate', '$state', '$timeout', function (payment, paymentsService, $stateParams, loadCurrentDate, $state, $timeout) {
                        ...
                        payment.promises.loadPayment =paymentsService.get($stateParams.referenceId).then(function (data) {
                            angular.extend(payment.formData, {
                                ...
                                amount: data.amount,
                                currency: data.currency,
                                province: data.paymentDetails.creditAccountProvinceCode,
                                bankCode: data.paymentDetails.creditAccountBankCode,
                                branchCode: data.paymentDetails.creditAccountBankBranchCode,
            ...
            .state('payments.external.future.delete', {
                url: '/delete',
                abstract: true,
                data: {
                    operation: 'delete'
    ...
    .controller('PaymentsExternalController', function ($scope, $state, $q, payment, rbRecipientTypes, translate) {
        ...
        function saveRecipient () {
            ...
            $state.go('payments.recipients.manage.new.fill', {
                ...
                recipient: {
                    ...
                    recipientType: rbRecipientTypes.EXTERNAL,
