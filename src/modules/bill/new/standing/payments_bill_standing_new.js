angular.module('ocb-payments')
    ...
    .controller('BillStandingPaymentFillController', function ($scope, $filter, lodash, bdFocus, $timeout,
        ...
        var initialState = viewStateService.getInitialState('payments.bill');
