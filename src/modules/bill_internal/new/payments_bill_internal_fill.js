angular.module('ocb-payments')
    .config(function (pathServiceProvider, stateServiceProvider) {
        stateServiceProvider.state('payments.bill_internal.fill', {
            url: "/fill/:accountId/:nrb",
            templateUrl: pathServiceProvider.generateTemplatePath("ocb-payments") + "/modules/bill_internal/fill/payments_bill_internal_fill.html",
            controller: "BillPaymentInternalFillController",
            params: {
                accountId: null,
                recipientId: null
            },
