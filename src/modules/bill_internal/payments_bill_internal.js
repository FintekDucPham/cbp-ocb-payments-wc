angular.module('ocb-payments')
    .config(function (pathServiceProvider, stateServiceProvider) {
        stateServiceProvider.state('payments.bill_internal', {
            url: "/bill-internal/:referenceId",
            abstract: true,
            templateUrl: pathServiceProvider.generateTemplatePath("ocb-payments") + "/modules/bill_internal/payments_bill_internal.html",
            controller: "PaymentsBillInternalController",
            params: {
                payment: {},
                items: {}
            },
    ...
    .controller('PaymentsBillInternalController', function ($scope, bdMainStepInitializer, rbPaymentTypes, rbPaymentOperationTypes, pathService, translate, $stateParams, $state, lodash, viewStateService, rbPaymentInitFactory, rbBeforeTransferConstants, CURRENT_DATE) {
        ...
        bdMainStepInitializer($scope, 'payment', lodash.extend({
            ...
            operation: rbPaymentOperationTypes.BILL,
            token: {
                model: null,
                params: {}
            },
